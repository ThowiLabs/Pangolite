...
async function route(options={}){
  ...
  document.querySelectorAll('[data-project-nav="'+id+'"]').forEach(a=>a.classList.add('active'));
  updateProjectSwitcherLabel();
  const hasBootProject=initial&&appBoot&&appBoot.hasProject&&currentProject&&currentProject.id===id;
  if(!hasBootProject){
    await loadProjectData(id);
  }else{
    fillAgentSelect();
  }
  setHrefIfExists('goCreateResource','/projects/'+id+'/resources/create');
  setHrefIfExists('goCreateAgent','/projects/'+id+'/agents/create');
  setHrefIfExists('goResources','/projects/'+id+'/resources');
  setHrefIfExists('goAgents','/projects/'+id+'/agents');
  setHrefIfExists('goCreateResourceFromList','/projects/'+id+'/resources/create');
